...
面试官你好，我叫 xx，从 xx 毕业，因 xxx 和前端结缘，现在将近 9.5 年的工作经验，认为和咱们公司这个岗位比较匹配就投递了一下。
...
第三家公司在 xxx 技术中台，部门 100 个人，云服务产品（容器、日志、网关、mlops、运维平台），大数据产品（日志、数据查询、服务、质量），自研低代码问卷平台等，主要用到 xxx 技术。前期带几个外包一起开发，后期主力开发人员。2022 年度团队协作奖。产品、设计、解决方案等。 

第四家公司 xx科技，主要负责 前端 项目（coco ai, es 后台管理平台，cloud 管理平台，前端公共组件库，官网等），主要用到 react、tauri 技术，前端 4 人，主要负责项目的需求分析、项目的设计、项目的开发、项目的测试、项目的上线。
