...
c + w 删除当前单词
e + a 在当前单词处添加
</code></pre><blockquote><p>寄存器：复制的内容都存放在寄存器里边，粘贴则从里边取出</p></blockquote>`,17),c=[r];function h(i,o){return a(),n("div",null,c)}const s=e(d,[["render",h],["__file","day3.html.vue"]]);export{s as default};
