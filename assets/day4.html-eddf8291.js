import{_ as e,o as d,c as a,e as r}from"./app-d4ce02b3.js";const n={},o=r(`<h1 id="day4" tabindex="-1"><a class="header-anchor" href="#day4" aria-hidden="true">#</a> day4</h1><h2 id="目标-更有效率的处理单字符-undo-redo" tabindex="-1"><a class="header-anchor" href="#目标-更有效率的处理单字符-undo-redo" aria-hidden="true">#</a> 目标：更有效率的处理单字符 &amp; undo/redo</h2><h2 id="新的知识点" tabindex="-1"><a class="header-anchor" href="#新的知识点" aria-hidden="true">#</a> 新的知识点</h2><pre><code>1、删除光标所在的字符 ——&gt; x
2、删除光标前的字符 ——&gt; X
